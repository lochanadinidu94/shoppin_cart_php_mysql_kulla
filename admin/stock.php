...
$getStock = $products->getStockSize();
    ...
    <div class="main_container">
        ...
        <div class="right_col" role="main" style="min-height: 0px;">
            ...
            <div class="row" style="border-radius:25px;border : 1px solid #993f41">
                <h3 align="center">Lowest Stock - Products</h3>
                                ...
                                foreach($getStock as $row){
                                    echo '
                                        <tr>
                                            <td>'.$row->id.'</td>
                                            <td>'.$row->title.'</td>
                                            <td>'.$row->stock_size.'</td>
                                            <td><a href="product_edit.php?id='.$row->id.'" class="btn btn-default">Update</a></td>
                                        </tr>
                                    ';
                                }
